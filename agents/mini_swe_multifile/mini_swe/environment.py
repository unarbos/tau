"""Local bash execution environment, ported from mini-swe-agent's
LocalEnvironment. Each action runs in a fresh subshell at the repository
root with merged stdout/stderr."""
